...
export default function MarketingLayout({
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-[#060A0E] text-white overflow-hidden selection:bg-primary/30">
      {/* Deep ambient background */}
      <div 
        className={cn("pointer-events-none fixed inset-0 z-0 opacity-40 mix-blend-screen", tokens.gradients.classes.meshDark)}
      />
