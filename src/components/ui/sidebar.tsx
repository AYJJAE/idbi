...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        'h-full px-4 py-4 hidden md:flex md:flex-col bg-card w-[260px] flex-shrink-0 border-r border-border',
        className
      )}
      animate={{
...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        'flex items-center justify-start gap-2 group/sidebar py-2 px-2 hover:bg-accent rounded-md',
        className
      )}
      {...props}
    >
